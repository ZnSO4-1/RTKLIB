# rnx2rtkp PPP-static regression test / rnx2rtkp PPP 静态回归测试
...
set(output_file "${OUTPUT_DIR}/rnx2rtkp_ppp_static_07590920.pos")
file(REMOVE "${output_file}")

execute_process(
    COMMAND "${RNX2RTKP}" -p 7 -o "${output_file}"
...
if(NOT result EQUAL 0)
    message(FATAL_ERROR "rnx2rtkp PPP-static regression command failed: ${result}")
endif()
...
if(NOT compare_result EQUAL 0)
    message(FATAL_ERROR
        "rnx2rtkp PPP-static regression output differs from baseline\n"
