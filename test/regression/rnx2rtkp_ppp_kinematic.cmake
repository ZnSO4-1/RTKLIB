# rnx2rtkp PPP-kinematic regression test / rnx2rtkp PPP 动态回归测试
...
set(output_file "${OUTPUT_DIR}/rnx2rtkp_ppp_kinematic_07590920.pos")
file(REMOVE "${output_file}")

execute_process(
    COMMAND "${RNX2RTKP}" -p 6 -o "${output_file}"
...
if(NOT result EQUAL 0)
    message(FATAL_ERROR "rnx2rtkp PPP-kinematic regression command failed: ${result}")
endif()
...
if(NOT compare_result EQUAL 0)
    message(FATAL_ERROR
        "rnx2rtkp PPP-kinematic regression output differs from baseline\n"
