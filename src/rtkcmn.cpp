...
extern int readnav(const char *file, nav_t *nav)
{
    ...
    while (fgets(buff,sizeof(buff),fp)) {
        ...
        long long toe=0,toc=0,ttr=0;
        sscanf(p+1,"%d,%d,%d,%d,%lld,%lld,%lld,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,"
                    "%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%d,%d",
               &nav->eph[sat-1].iode,&nav->eph[sat-1].iodc,&nav->eph[sat-1].sva ,
               &nav->eph[sat-1].svh ,&toe,&toc,&ttr,
        ...
        nav->eph[sat-1].toe.time=(time_t)toe;
        nav->eph[sat-1].toc.time=(time_t)toc;
        nav->eph[sat-1].ttr.time=(time_t)ttr;
    }
    fclose(fp);
    return 1;
}
