...
extern const double range[4];       /* embedded geoid area range {W,E,S,N} (deg) */
extern const float geoid[361][181]; /* embedded geoid heights (m) (lon x lat) */
